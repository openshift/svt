...
from clusterloader_tests import *
...
def driver():
    ...
    cliparser.add_option("-m","--mock",dest="mock", default=False, help="Does a dry run")
    ...
    if user and passwd and master:
        client.login(user, passwd, master)
    ...
    for config in testconfig["projects"]:
        ...
        project_handler(client,config,globalvars)
